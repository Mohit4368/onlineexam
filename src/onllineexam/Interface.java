...
{  
    ...
    {  
        ...
        if(current==0)  
        {  
            l.setText("Que1: What is cout?");  
            jb[0].setText("Operator");jb[1].setText("Object");jb[2].setText("Function");jb[3].setText("Macro");   
        }  
        if(current==1)  
        {  
        ...
        if(current==2)  
        {  
            l.setText("Que3: Total instances of an abstract class that can be created?");  
            jb[0].setText("0");jb[1].setText("1 ");jb[2].setText("4");jb[3].setText("8");  
        }  
        if(current==3)  
        {  
            l.setText("Que4: Another name of the generic class is?");  
            jb[0].setText("template class");jb[1].setText("final class");jb[2].setText("abstract class");jb[3].setText("efficient code");  
        }  
        if(current==4)  
        {  
        ...
        if(current==8)  
        {  
            l.setText("Que9: How do encapsulation and abstraction differ ?");  
            jb[0].setText("Hiding and binding");jb[1].setText("Binding and hiding");jb[2].setText("Hinding and hiding");jb[3].setText("None");  
        }  
        if(current==9)  
        {  
            l.setText("Que10: Virtual function should be ");  
            jb[0].setText("public ");jb[1].setText("private");jb[2].setText("protected");  
                        jb[3].setText("default");  
        }  
        l.setBounds(30,40,450,20);  
